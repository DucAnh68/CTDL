//Kiểm tra xem giá trị các phần tử trong danh sách có theo thứ tự tăng dần không? Nếu giá trị các phần tử trong danh sách theo thứ tự tăng dần, chèn phần tử có giá trị bằng x vào danh sách sao cho danh sách vẫn tăng dần?
#include<iostream>
using namespace std;
struct node {
	int info;
